+++
title = "把引理当语句调用：triangle(100) 与上下文注入"
date = 2026-08-18
categories = ["COMP6260"]
...
出处：Lecture 08 "Functional Dafny and Proofs"，对应文件 `nat-inductions.dfy`（slide 7，slide 19–20 为 "cloud" 机制）。题面出自 `lab02.dfy` 第 178–192 行的 triangle 练习。
